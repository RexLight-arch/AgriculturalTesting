...
//订阅与发布的主题
#define RELY_PUBLISH_TOPIC  "Go_IoTAE"  //属性设置应答订阅主题,onenet studio定义好的
#define SET_TOPIC  "Go_IoTAE"
#define POST_TOPIC "Go_IoTAE"
//事件上报主题
#define EVENT_PUBLISH_TOPIC   "$sys/YOUR_PRODUCT_KEY/YOUR_DEVICE_NAME/thing/event/post"  //发布主题,onenet studio定义好的
